...
public class DvbTeletextApi {
    ...
    interface DvbTeletextApiClient {
        ...
        ResponseEnvelope<PaginationResponse<DvbTeletextInputStream>> list(@Param(value = "encoding_id") String encodingId, @QueryMap QueryMapWrapper queryParams) throws BitmovinException;
    }
}
