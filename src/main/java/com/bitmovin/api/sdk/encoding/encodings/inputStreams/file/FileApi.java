...
public class FileApi {
    ...
    interface FileApiClient {
        ...
        ResponseEnvelope<PaginationResponse<FileInputStream>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
