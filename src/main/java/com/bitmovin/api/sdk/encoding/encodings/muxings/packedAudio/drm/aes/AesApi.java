package com.bitmovin.api.sdk.encoding.encodings.muxings.packedAudio.drm.aes;
...
import com.bitmovin.api.sdk.encoding.encodings.muxings.packedAudio.drm.aes.customdata.CustomdataApi;
...
public class AesApi {
    ...
    interface AesApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/packed-audio/{muxing_id}/drm/aes")
        ResponseEnvelope<PaginationResponse<AesEncryptionDrm>> list(@Param(value = "encoding_id") String encodingId, @Param(value = "muxing_id") String muxingId, @QueryMap QueryMapWrapper queryParams) throws BitmovinException;
    }
}
