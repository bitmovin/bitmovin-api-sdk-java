package com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.widevine;
...
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.widevine.customdata.CustomdataApi;
...
public class WidevineApi {
    ...
    interface WidevineApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine")
