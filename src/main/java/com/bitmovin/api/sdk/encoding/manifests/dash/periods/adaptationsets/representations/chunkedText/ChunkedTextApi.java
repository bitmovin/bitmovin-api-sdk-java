...
public class ChunkedTextApi {
    ...
    interface ChunkedTextApiClient {
        ...
        ResponseEnvelope<PaginationResponse<DashChunkedTextRepresentation>> list(@Param(value = "manifest_id") String manifestId, @Param(value = "period_id") String periodId, @Param(value = "adaptationset_id") String adaptationsetId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
