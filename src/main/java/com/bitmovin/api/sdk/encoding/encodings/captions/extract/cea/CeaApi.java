package com.bitmovin.api.sdk.encoding.encodings.captions.extract.cea;
...
import com.bitmovin.api.sdk.encoding.encodings.captions.extract.cea.customdata.CustomdataApi;
...
public class CeaApi {
    ...
    interface CeaApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/captions/extract/cea")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/cea")
