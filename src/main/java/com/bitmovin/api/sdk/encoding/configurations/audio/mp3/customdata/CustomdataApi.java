package com.bitmovin.api.sdk.encoding.configurations.audio.mp3.customdata;
...
public class CustomdataApi {
    ...
    interface CustomdataApiClient { 
        @RequestLine("GET /encoding/configurations/audio/mp3/{configuration_id}/customData")
