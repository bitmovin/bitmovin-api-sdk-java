package com.bitmovin.api.sdk.encoding.configurations.audio.dts.customdata;
...
public class CustomdataApi {
    ...
    interface CustomdataApiClient { 
        @RequestLine("GET /encoding/configurations/audio/dts/{configuration_id}/customData")
