...
public class MxfApi {
    ...
    interface MxfApiClient {
        ...
        ResponseEnvelope<PaginationResponse<MxfMuxing>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
