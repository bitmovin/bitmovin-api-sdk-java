...
public class Cea608Api {
    ...
    interface Cea608ApiClient {
        ...
        ResponseEnvelope<PaginationResponse<Cea608CaptionInputStream>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
