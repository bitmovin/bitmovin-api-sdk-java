package com.bitmovin.api.sdk.encoding.encodings.muxings.progressiveWav.information;
...
public class InformationApi {
     ...
     */
    public ProgressiveWavMuxingInformation get(String encodingId, String muxingId) throws BitmovinException {
        try {
    ...
    interface InformationApiClient {
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/progressive-wav/{muxing_id}/information")
        ResponseEnvelope<ProgressiveWavMuxingInformation> get(@Param(value = "encoding_id") String encodingId, @Param(value = "muxing_id") String muxingId) throws BitmovinException;
    }
}
