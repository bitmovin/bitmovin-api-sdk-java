...
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.captions.ttml.customdata.CustomdataApi;
...
public class TtmlApi {
    ...
    interface TtmlApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/captions/ttml")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/captions/ttml")
