...
public class TransferRetriesApi {
    ...
    interface TransferRetriesApiClient {
        ...
        ResponseEnvelope<PaginationResponse<TransferRetry>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
