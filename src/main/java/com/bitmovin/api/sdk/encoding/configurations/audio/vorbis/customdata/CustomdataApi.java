package com.bitmovin.api.sdk.encoding.configurations.audio.vorbis.customdata;
...
public class CustomdataApi {
    ...
    interface CustomdataApiClient { 
        @RequestLine("GET /encoding/configurations/audio/vorbis/{configuration_id}/customData")
