package com.bitmovin.api.sdk.encoding.encodings.customdata;
...
public class CustomdataApi {
     ...
     */
    public CustomData getCustomData(String encodingId) throws BitmovinException {
        try {
            return this.apiClient.getCustomData(encodingId).getData().getResult();
        } catch (Exception ex) {
