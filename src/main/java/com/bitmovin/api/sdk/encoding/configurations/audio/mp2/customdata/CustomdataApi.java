package com.bitmovin.api.sdk.encoding.configurations.audio.mp2.customdata;
...
public class CustomdataApi {
    ...
    interface CustomdataApiClient { 
        @RequestLine("GET /encoding/configurations/audio/mp2/{configuration_id}/customData")
