...
public class VideoApi {
    ...
    interface VideoApiClient {
        ...
        ResponseEnvelope<PaginationResponse<VideoAdaptationSet>> list(@Param(value = "manifest_id") String manifestId, @Param(value = "period_id") String periodId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
