...
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.widevine.WidevineApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.playready.PlayreadyApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.primetime.PrimetimeApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.fairplay.FairplayApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.marlin.MarlinApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.clearkey.ClearkeyApi;
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.cenc.CencApi;
...
public class DrmApi {
    ...
    interface DrmApiClient {
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm")
