package com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.cenc;
...
import com.bitmovin.api.sdk.encoding.encodings.muxings.cmaf.drm.cenc.customdata.CustomdataApi;
...
public class CencApi {
    ...
    interface CencApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/cenc")
