package com.bitmovin.api.sdk.encoding.encodings.captions.extract.webvtt;
...
import com.bitmovin.api.sdk.encoding.encodings.captions.extract.webvtt.customdata.CustomdataApi;
...
public class WebvttApi {
    ...
    interface WebvttApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/captions/extract/webvtt")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/captions/extract/webvtt/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/webvtt/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/webvtt")
