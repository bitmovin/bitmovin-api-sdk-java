...
public class ProgressiveWebmApi {
    ...
    interface ProgressiveWebmApiClient {
        ...
        ResponseEnvelope<PaginationResponse<DashProgressiveWebmRepresentation>> list(@Param(value = "manifest_id") String manifestId, @Param(value = "period_id") String periodId, @Param(value = "adaptationset_id") String adaptationsetId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
