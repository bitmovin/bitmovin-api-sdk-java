...
public class DolbyAtmosApi {
    ...
    interface DolbyAtmosApiClient {
        ...
        ResponseEnvelope<PaginationResponse<DolbyAtmosIngestInputStream>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
