package com.bitmovin.api.sdk.encoding.encodings.captions.extract.ttml;
...
import com.bitmovin.api.sdk.encoding.encodings.captions.extract.ttml.customdata.CustomdataApi;
...
public class TtmlApi {
    ...
    interface TtmlApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/captions/extract/ttml")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/captions/extract/ttml/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/ttml/{captions_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/ttml")
