...
public class DvbSubtitleApi {
    ...
    interface DvbSubtitleApiClient {
        ...
        ResponseEnvelope<PaginationResponse<DvbSubtitleInputStream>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
