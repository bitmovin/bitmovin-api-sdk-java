...
public class Mp4Api {
    ...
    interface Mp4ApiClient {
        ...
        ResponseEnvelope<PaginationResponse<SmoothStreamingRepresentation>> list(@Param(value = "manifest_id") String manifestId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
