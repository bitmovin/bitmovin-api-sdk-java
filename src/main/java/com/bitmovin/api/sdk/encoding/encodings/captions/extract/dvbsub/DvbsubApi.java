package com.bitmovin.api.sdk.encoding.encodings.captions.extract.dvbsub;
...
import com.bitmovin.api.sdk.encoding.encodings.captions.extract.dvbsub.customdata.CustomdataApi;
...
public class DvbsubApi {
    ...
    interface DvbsubApiClient {
        ...
        @RequestLine("POST /encoding/encodings/{encoding_id}/captions/extract/dvbsub")
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/captions/extract/dvbsub/{subtitle_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/dvbsub/{subtitle_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/captions/extract/dvbsub")
