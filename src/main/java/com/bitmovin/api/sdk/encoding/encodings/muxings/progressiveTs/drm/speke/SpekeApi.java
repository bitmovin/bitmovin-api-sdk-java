package com.bitmovin.api.sdk.encoding.encodings.muxings.progressiveTs.drm.speke;
...
import com.bitmovin.api.sdk.encoding.encodings.muxings.progressiveTs.drm.speke.customdata.CustomdataApi;
...
public class SpekeApi {
    ...
    interface SpekeApiClient { 
        ...
        @RequestLine("DELETE /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/speke/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/speke/{drm_id}")
        ...
        @RequestLine("GET /encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/speke")
