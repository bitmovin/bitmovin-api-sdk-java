...
public class ProgressiveMovApi {
    ...
    interface ProgressiveMovApiClient {
        ...
        ResponseEnvelope<PaginationResponse<ProgressiveMovMuxing>> list(@Param(value = "encoding_id") String encodingId, @QueryMap Map<String, Object> queryParams) throws BitmovinException;
    }
}
