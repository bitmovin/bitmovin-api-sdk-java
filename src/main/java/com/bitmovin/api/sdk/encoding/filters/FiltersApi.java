...
import com.bitmovin.api.sdk.encoding.filters.dolbyLoudness.DolbyLoudnessApi;
...
public class FiltersApi {
    ...
    public final DolbyLoudnessApi dolbyLoudness;
    ...
    public FiltersApi(BitmovinApiClientFactory clientFactory) {
        ...
        this.dolbyLoudness = new DolbyLoudnessApi(clientFactory);
