package com.bitmovin.api.sdk.encoding.filters.enhancedDeinterlace.customdata;
...
public class CustomdataApi {
    ...
    interface CustomdataApiClient { 
        @RequestLine("GET /encoding/filters/enhanced-deinterlace/{filter_id}/customData")
