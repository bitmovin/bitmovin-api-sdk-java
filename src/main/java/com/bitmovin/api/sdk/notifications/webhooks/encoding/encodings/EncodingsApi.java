...
import com.bitmovin.api.sdk.notifications.webhooks.encoding.encodings.liveManifestReady.LiveManifestReadyApi;
...
public class EncodingsApi {
    ...
    public final LiveManifestReadyApi liveManifestReady;
    ...
    public EncodingsApi(BitmovinApiClientFactory clientFactory) {
        ...
        this.liveManifestReady = new LiveManifestReadyApi(clientFactory);
