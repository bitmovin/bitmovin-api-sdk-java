...
public enum DolbyAtmosDynamicRangeCompressionMode {
  ...
  DolbyAtmosDynamicRangeCompressionMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DolbyAtmosDynamicRangeCompressionMode fromValue(String text) {
    for (DolbyAtmosDynamicRangeCompressionMode b : DolbyAtmosDynamicRangeCompressionMode.values()) {
