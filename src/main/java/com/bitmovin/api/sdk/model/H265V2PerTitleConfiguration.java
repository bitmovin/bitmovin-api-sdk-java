...
public class H265V2PerTitleConfiguration extends PerTitleConfiguration {
   ...
   */
  public Integer getTargetQualityQp() {
    return targetQualityQp;
  }
   ...
   * Desired target quality of the highest representation expressed as QP value used for the CQP probe encode
   *
   * @param targetQualityQp
   *        Desired target quality of the highest representation expressed as QP value used for the CQP probe encode
   */
  public void setTargetQualityQp(Integer targetQualityQp) {
  ...
  public String toString() {
    ...
    sb.append("class H265V2PerTitleConfiguration {\n");
