...
public enum DolbyDigitalPlusChannelLayout {
  ...
  DolbyDigitalPlusChannelLayout(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DolbyDigitalPlusChannelLayout fromValue(String text) {
    for (DolbyDigitalPlusChannelLayout b : DolbyDigitalPlusChannelLayout.values()) {
