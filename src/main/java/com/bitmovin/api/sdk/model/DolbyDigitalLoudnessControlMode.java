...
public enum DolbyDigitalLoudnessControlMode {
  ...
  DolbyDigitalLoudnessControlMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DolbyDigitalLoudnessControlMode fromValue(String text) {
    for (DolbyDigitalLoudnessControlMode b : DolbyDigitalLoudnessControlMode.values()) {
