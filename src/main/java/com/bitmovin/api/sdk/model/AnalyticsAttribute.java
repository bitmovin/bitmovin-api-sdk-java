...
/**
 * Gets or Sets AnalyticsAttribute
 */
public enum AnalyticsAttribute {
  ...
  AnalyticsAttribute(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AnalyticsAttribute fromValue(String text) {
    for (AnalyticsAttribute b : AnalyticsAttribute.values()) {
