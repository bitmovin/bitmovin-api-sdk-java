...
public enum DolbyDigitalLoudnessControlRegulationType {
  ...
  DolbyDigitalLoudnessControlRegulationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DolbyDigitalLoudnessControlRegulationType fromValue(String text) {
    for (DolbyDigitalLoudnessControlRegulationType b : DolbyDigitalLoudnessControlRegulationType.values()) {
