 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type", visible = false, defaultImpl = AgentChatMessagePart.class)
@JsonSubTypes({
...
public class AgentChatMessagePart {
  ...
  public String toString() {
    ...
    sb.append("class AgentChatMessagePart {\n");
