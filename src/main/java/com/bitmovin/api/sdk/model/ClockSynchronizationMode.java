...
public enum ClockSynchronizationMode {
  ...
  ClockSynchronizationMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ClockSynchronizationMode fromValue(String text) {
    for (ClockSynchronizationMode b : ClockSynchronizationMode.values()) {
