 ...
 * GenericS3Input
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "type", visible = false, defaultImpl = GenericS3Input.class)
public class GenericS3Input extends Input {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.bucketName, genericS3Input.bucketName) &&
        ...
        Objects.equals(this.signingRegion, genericS3Input.signingRegion) &&
        ...
        Objects.equals(this.accessStyle, genericS3Input.accessStyle) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bucketName, host, port, ssl, signingRegion, signatureVersion, accessKey, secretKey, accessStyle, super.hashCode());
  }
