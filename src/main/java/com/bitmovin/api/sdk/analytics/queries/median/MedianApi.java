package com.bitmovin.api.sdk.analytics.queries.median;
...
public class MedianApi {
    ...
    public AnalyticsResponse create(AnalyticsMedianQueryRequest analyticsMedianQueryRequest) throws BitmovinException {
        try {
            return this.apiClient.create(analyticsMedianQueryRequest).getData().getResult();
        } catch (Exception ex) {
    ...
    interface MedianApiClient {
        ...
        ResponseEnvelope<AnalyticsResponse> create(AnalyticsMedianQueryRequest analyticsMedianQueryRequest) throws BitmovinException;
    }
}
