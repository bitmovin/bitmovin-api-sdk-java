package com.bitmovin.api.sdk.analytics.queries.min;
...
public class MinApi {
     ...
     * Min
     * 
     * @param analyticsMinQueryRequest Analytics Query Object (required)
     * @return AnalyticsResponse
     * @throws BitmovinException if fails to make API call
     */
    public AnalyticsResponse create(AnalyticsMinQueryRequest analyticsMinQueryRequest) throws BitmovinException {
        try {
            return this.apiClient.create(analyticsMinQueryRequest).getData().getResult();
        } catch (Exception ex) {
